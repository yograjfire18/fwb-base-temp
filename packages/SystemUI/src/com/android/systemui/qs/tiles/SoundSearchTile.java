...
public class SoundSearchTile extends QSTileImpl<BooleanState> {
    ...
    protected void handleClick(@Nullable View view) {
        ...
        // Soundhound
        if (derpUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier.freemium") || derpUtils.isPackageInstalled(mContext, "com.melodis.midomiMusicIdentifier")) {
